...
export const translations = {
  id: {
    ...
    dashboard_sub: 'Metrik waktu nyata, skor breakout, dan pilihan teknis.',
    active_watchlist: 'Daftar Pantau Aktif',
    items_added: 'item baru minggu ini',
    top_recommendation: 'Rekomendasi Utama',
    btst_score_label: 'Skor Breakout BTST',
    market_status: 'Status Pasar',
    idx_closes: 'IHSG tutup dalam 4 jam',
    top_btst_recs: 'Rekomendasi Breakout BTST Teratas',
    breakout_verified: 'Momentum breakout terverifikasi',
    view: 'Lihat',
    daily_ai_insight: 'Wawasan AI Harian',
    powered_by_gemini: 'Didukung oleh Gemini Flash API',
    // Screener translations
    screener_overview: 'BTST Breakout Screener',
    screener_sub: 'Pindai dan urutkan aset berdasarkan 5 poin skor momentum teknis.',
    ...
    us_market_toggle_desc: 'Ketika diaktifkan, sistem akan mengunduh dan menganalisa saham pasar AS seperti AAPL, TSLA, NVDA. Ketika dinonaktifkan, sistem hanya menganalisis saham pasar lokal Indonesia (IDX) untuk mencegah penggunaan rate limit API yang sia-sia.',
  ...
  en: {
    ...
    dashboard_sub: 'Real-time metrics, breakout scores, and technical picks.',
    active_watchlist: 'Active Watchlist',
    items_added: 'new items this week',
    top_recommendation: 'Top Recommendation',
    btst_score_label: 'BTST Breakout Score',
    market_status: 'Market Status',
    idx_closes: 'IDX closes in 4 hours',
    top_btst_recs: 'Top BTST Breakout Recs',
    breakout_verified: 'Breakout momentum verified',
    view: 'View',
    daily_ai_insight: 'Daily AI Insight',
    powered_by_gemini: 'Powered by Gemini Flash API',
    // Screener translations
    screener_overview: 'BTST Breakout Screener',
    screener_sub: 'Scan and rank assets based on the 5-point technical momentum score.',
    ...
    us_market_toggle_desc: 'When enabled, the system will ingest and analyze US stocks such as AAPL, TSLA, NVDA. When disabled, the system only analyzes local Indonesian IDX stocks to prevent unnecessary API rate limiting.',
